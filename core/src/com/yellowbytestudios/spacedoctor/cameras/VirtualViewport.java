...
public class VirtualViewport {
	...
	/**
	 * Returns the view port width to let all the virtual view port to be shown
	 * on the screen.
	 * 
	 * @param screenWidth
	 *            The screen width.
	...
	public float getWidth(float screenWidth, float screenHeight) {
		...
		if (aspect > virtualAspect
				|| (Math.abs(aspect - virtualAspect) < 0.01f)) {
	...
	/**
	 * Returns the view port height to let all the virtual view port to be shown
	 * on the screen.
	 * 
	 * @param screenWidth
	 *            The screen width.
